...
| ----- | ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------- |
| 26-04 | April 2026        | Agent-shaped development environments, Managed Agents, OpenSpec, Agent Primitives, Vercel AI deployment and security                         | [Download](26-04/26-04.pdf) |
